...
reactionRun folder contains input files for running biased density functional theory (DFT) quantum mechanics (QM)/ molecular mechanics (MM) molecular dynamics (MD) simulations with cp2k for the succinimide formation reaction in MjGATase.
